...
import 'package:instax/core/functions/blur_hash.dart';
...
import '../../../custom_packages/crop_image/crop_image.dart';
...
class _PopupNewPostState extends State<PopupNewPost> {
  ...
  Post addPostInfo(UserPersonalInfo personalInfo, String blurHash) {
    return Post(
      ...
      publisherInfo: personalInfo,
      publisherProfileUrl: personalInfo.profileImageUrl,
