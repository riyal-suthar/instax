...
import '../../cubit/user_info/search_about_user/search_about_user_bloc.dart';
  ...
  Widget build(BuildContext context1) {
    return BlocBuilder<UserInfoCubit, UserInfoState>(
      ...
      builder: (context, getUserState) {
        ...
        if (getUserState is GetUserInfoFailed) {
          ToastMessage.toastStateError(getUserState);
        }
  ...
  Widget userNameTextField(BuildContext context) {
    return ValueListenableBuilder(
      ...
      builder: (context, bool isImageUploadValue, child) =>
        ...
        buildWhen: (previous, current) =>
            previous != current &&
            (current is SearchAboutUserLoaded) &&
            isImageUploadValue,
