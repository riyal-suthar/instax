...
import 'package:instax/presentation/pages/time_line/widgets/welcome_cards.dart';
...
import '../../cubit/auth_cubit/firebase_auth_cubit.dart';
...
import '../register/sign_in_page.dart';
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, bool rebuildValue, child) =>
        ...
        buildWhen: (previous, current) {
          ...
          if (previous != current && current is GetUserInfoFailed) {
            return true;
          }
          if (rebuildValue) {
      ...
      if (state is CubitAuthSignOut) {
        WidgetsBinding.instance.addPostFrameCallback((_) async {
          ...
          Navigator.of(context, rootNavigator: true).pushAndRemoveUntil(
            CupertinoPageRoute(
                builder: (_) => const SignInPage(), maintainState: false),
            (route) => false,
          );
        });
      } else if (state is CubitAuthConfirming) {
        ToastMessage.toast(StringsManager.loading.tr);
