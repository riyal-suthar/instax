...
class _CreatePostPageState extends State<CreatePostPage> {
  ...
  Future<void> createPost(BuildContext context) async {
    ...
    if (postCubit.newPostInfo != null) {
      ...
      await UserInfoCubit.get(context).updatePostInfo(
          userId: myPersonalId, postInfo: postCubit.newPostInfo!);
      await postCubit.getPostsInfo(
          postIds: myPersonalInfo.posts, isThatMyPosts: true);
      WidgetsBinding.instance
  ...
  Post addPostInfo(String blurHash) {
    return Post(
      ...
      publisherInfo: myPersonalInfo,
      publisherName: myPersonalInfo.name,
      publisherProfileUrl: myPersonalInfo.profileImageUrl,
