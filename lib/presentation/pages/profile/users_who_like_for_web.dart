...
import 'package:instax/presentation/pages/profile/users_who_likes.dart';

import '../../../core/resources/color_manager.dart';
import '../../../core/resources/strings_manager.dart';
import '../../widgets/popup_widgets/common/head_of_popup_widget.dart';
      ...
      child: SizedBox(
        ...
        child: Material(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                TheHeadWidget(text: StringsManager.likes.tr),
                customDivider(),
                Expanded(
                  child: UsersWhoLikes(
                    showSearchBar: false,
