...
import 'package:instax/presentation/pages/messages/widgets/record_view.dart';
import 'package:instax/presentation/pages/messages/widgets/shared_message.dart';
...
import '../../../cubit/user_info/message/cubit/group_chat/message_for_group_chat_cubit.dart';
import '../../../cubit/user_info/message/cubit/message_cubit.dart';
...
import '../../../custom_packages/audio_recorder/social_media_recorder.dart';
...
import '../../../widgets/custom_widgets/custom_memory_image_display.dart';
...
class _ChatMessagesState extends State<ChatMessages>
    ...
    if (messageDetails.lastMessage == null || isGroupIdEmpty) {
      ...
      return ValueListenableBuilder(
        ...
        builder: (context, bool reLoadValue, child) =>
          ...
          bloc: BlocProvider.of<GetMessagesBloc>(context)
  ...
  BlocBuilder<UserInfoCubit, UserInfoState> senderNameText(
    ...
    return BlocBuilder<UserInfoCubit, UserInfoState>(
      ...
      builder: (context, state) {
        ...
        if (state is UserLoaded) userInfo = state.userInfo;
  ...
  Future<void> onSelectImage(
    ...
    if (pickImage != null) {
      ...
      ToastMessage.toast(StringsManager.noImageSelected.tr);
    }
  }
