...
import '../../../cubit/postInfo_cubit/comment_cubit/comments_info_cubit.dart';
...
class CommentBox extends StatefulWidget {
  ...
  const CommentBox(
      ...
      this.isThatCommentScreen = false,
...
class _CommentBoxState extends State<CommentBox> {
          ...
          child: Row(
            ...
            children: [
              CircleAvatarOfProfileImage(
                  userInfo: widget.userPersonalInfo, bodyHeight: 330),
              const SizedBox(
                width: 20,
              ),
              Expanded(
  ...
  Future<void> postTheComment(
    ...
    if (selectedComment == null) {
      ...
      Comment replyInfo = newReplyInfo(selectedComment, myPersonalInfo.userId,
          myPersonalInfo.userName, textWithOneSpaces);
  ...
  Comment newReplyInfo(Comment commentInfo, String myPersonalId,
      String myUserName, String textWithOneSpaces) {
    return Comment(
      datePublished: DateReformat.dateOfNow(),
