...
import '../../presentation/pages/messages/chatting_page.dart';
import '../../presentation/pages/messages/video_call_page.dart';
import '../../presentation/pages/profile/widgets/which_profile_page.dart';
import '../../presentation/widgets/custom_widgets/get_post_display.dart';
...
Future<void> _loadFCM(BuildContext context) async {
  ...
  _normalLocalNotifications.initialize(
    initializationSettings,
    onDidReceiveNotificationResponse: (p) =>
        _onSelectNotification(context, p.payload),
    // onSelectNotification: (p) => _onSelectNotification(context, p)
  );

  _videoCallLocalNotifications.initialize(
    initializationSettings,
    onDidReceiveNotificationResponse: (p) =>
        _onSelectNotification(context, p.payload),
    // onSelectNotification: (p) => _onSelectNotification(context, p)
